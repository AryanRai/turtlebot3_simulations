...
: Node("turtlebot3_drive_node")
{
    ...
    ************************************************************/
    this->declare_parameter("use_centering", false);  // false = right wall only (default, more reliable)
    ...
    if (use_centering) {
        ...
        RCLCPP_INFO(this->get_logger(), "Driving Mode: RIGHT WALL FOLLOW (default, more reliable)");
    }
